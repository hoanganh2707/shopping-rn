...
import { Button, Header, Input, Pressable, Text, Icon, Divider } from '~/components';
...
export const Login = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      showMessage('Đã có lỗi xảy ra khi đăng nhập với Google');
    }
  };
      ...
      <KeyboardAwareScrollView
        ...
        <Pressable style={styles.googleButton} onPress={handleGoogleSignIn}>
          ...
          <Text variant='labelLarge' style={styles.googleButtonText}>
            {t('signInWithGoogle') || 'Đăng nhập bằng Google'}
          </Text>
        </Pressable>
